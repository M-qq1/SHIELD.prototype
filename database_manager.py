...
def setup_complex_system():
    ...
    protocols = [
        ('C-1', 'Acute Coronary Syndrome (ACS)', 
         ...
         '1. Immediate 12-lead ECG (Target < 10 mins). 2. Oxygen if SpO2 < 94%. 3. Aspirin 324mg (Chewed). 4. Nitroglycerin 0.4mg SL every 5 mins (Max 3 doses) IF SBP > 90. 5. Fentanyl 50-100mcg for pain. 6. Early STEMI Notification to PCI Center.'),
